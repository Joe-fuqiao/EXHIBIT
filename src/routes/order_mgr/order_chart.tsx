                ...
                >
                  ...
                  <Legend
                    ...
                    itemTpl={(item, color, isShow, index: any) => {
                      ...
                      data-value="{originValue}" style="display: flex; justify-content: space-between; align-items: center;
                       min-width: ${locale === "zh" ? "180px" : "130px"};color: #FFFFFF;font-weight:400;
                       cursor: pointer;font-size: 14px;max-width: 80%">
